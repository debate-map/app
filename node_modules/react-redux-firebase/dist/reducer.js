...
for (var key in emptyState) {
	initialState[key] = emptyState[key];
}*/
var initialState = emptyState;

var u = require("updeep");

function AddImmutableJSReplacementFuncsTo(obj) {
	//getIn(searchKeyPath: Iterable<any>, notSetValue?: any): any
	obj.getIn = function(pathNodes, notSetValue) {
		let result = this;
...
_immutable.fromJS = function(a) { return a; };
// ==========
...
exports.default = function () {
  ...
  AddImmutableJSReplacementFuncsTo(state); // custom
  ...
  switch (action.type) {
    ...
    case LOGOUT:
      ...
      /*return (0, _immutable.fromJS)({
		...
		return state.setIn(['auth'], null).setIn(['authError'], null).setIn(['profile'], null).setIn(['isInitializing'], false);
