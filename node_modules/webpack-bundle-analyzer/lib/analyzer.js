  ...
  var assets = _.transform(bundleStats.assets, function (result, statAsset) {
    ...
    asset.modules = _(bundleStats.modules).filter(function (statModule) {
      ...
      if (parsedModuleSizes) {
			...
			statModule.parsedSize = parsedModuleSizes[statModule.id] ? parsedModuleSizes[statModule.id].raw : 0;
       	statModule.gzipSize = parsedModuleSizes[statModule.id] ? parsedModuleSizes[statModule.id].gzip : 0;
      }
    });
