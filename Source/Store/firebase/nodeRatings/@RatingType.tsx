...
export class RatingType_Info {
	static for = {
		...
		probability: new RatingType_Info({
			...
			description: ()=>"Suppose you were as sure as you are right now (of this thesis), one hundred different times. How many of those times would you expect to be correct?",
