					...
					ShowMessageBox({
						...
						onOK: async ()=> {
							...
							data.nodes = {
								...
								2: new MapNode({
									type: MapNodeType.Category, titles: {base: "Science"},
									creator: user1Key, approved: true,
								}),
								3: new MapNode({
									type: MapNodeType.Category, titles: {base: "Philosophy"},
									creator: user1Key, approved: true,
								}),
								4: new MapNode({
									type: MapNodeType.Category, titles: {base: "Religion"},
									creator: user1Key, approved: true,
								}),
								5: new MapNode({
									type: MapNodeType.Category, titles: {base: "History"},
									creator: user1Key, approved: true,
								}),
								6: new MapNode({
									type: MapNodeType.Category, titles: {base: "Politics"},
									creator: user1Key, approved: true,
								}),
								7: new MapNode({
									type: MapNodeType.Category, titles: {base: "Issues"},
									creator: user1Key, approved: true,
								}),
								8: new MapNode({
									type: MapNodeType.Category, titles: {base: "Everyday"},
									creator: user1Key, approved: true,
								}),
								9: new MapNode({
									type: MapNodeType.Category, titles: {base: "Others"},
									creator: user1Key, approved: true,
								}),
							};
							data.nodeExtras = {
