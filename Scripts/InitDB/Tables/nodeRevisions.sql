...
CREATE OR REPLACE VIEW app.my_node_revisions AS
    WITH q1 AS (
        ...
        SELECT app."nodeRevisions".* FROM app."nodeRevisions" JOIN q1 ON (is_user_admin(current_setting('app.current_user_id')) OR ("c_accessPolicyTargets" && q1.pol));
