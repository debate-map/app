...
use rust_shared::{
	async_graphql::{self, parser::types::ExecutableDocument, InputObject, InputType, InputValueError, InputValueResult, Name, OutputType, Scalar, ScalarType, SimpleObject, Value},
	indexmap::IndexMap,
...
impl<T> ScalarType for IndexMapAGQL<String, T>
where
