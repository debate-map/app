...
process.env.NEW_RELIC_APP_NAME = `monitor-backend${inLocalK8s ? "-dev" : ""}`;
...
module.exports = {
	apps: [{
		...
		script: `echo sleep0; sleep 1; echo sleep1; sleep 1; echo sleep2; sleep 1; echo sleep3; monitor-backend.exe`,
		interpreter: null,
