...
import {HSLA, RunInAction} from "web-vcore";
import {DMap, MeID, IsUserMap} from "dm_common";
...
export const ActionBar_Left = observer_mgl((props: Props)=>{
	const {map, subNavBarWidth, backOnly} = props;
	const userID = MeID();
