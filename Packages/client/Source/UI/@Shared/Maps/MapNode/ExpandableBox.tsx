...
type Props = {
	parent?,
	className?: string, width: number|string|n, widthOverride: number|n, innerWidth?: number, outlineColor?: string|n, padding: number | string, style?, onClick?, onDirectClick?, onMouseEnter?: Function, onMouseLeave?: Function,
