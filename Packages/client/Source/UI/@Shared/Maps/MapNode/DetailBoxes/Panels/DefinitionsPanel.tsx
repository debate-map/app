...
export class DefinitionsPanel extends BaseComponentPlus(
	{} as {show: boolean, map: Map|n, node: MapNodeL2, path: string, hoverTermIDs?: string[]|n, openTermIDs?: string[]|n, onHoverTerm?: (termIDs: string[])=>void, onClickTerm?: (termIDs: string[])=>void},
