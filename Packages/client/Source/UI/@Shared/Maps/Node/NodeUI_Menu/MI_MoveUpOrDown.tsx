import {ChildGroup, ChildOrdering, GetChildOrdering_Final, GetNodeLinks, GetNodeL2, GetParentNodeID, MeID, Polarity, OrderKey, PERMISSIONS} from "dm_common";
...
export const MI_MoveUpOrDown = observer_mgl((props: MI_SharedProps & {direction: "up" | "down"})=>{
	const {direction, map, node, path} = props;
