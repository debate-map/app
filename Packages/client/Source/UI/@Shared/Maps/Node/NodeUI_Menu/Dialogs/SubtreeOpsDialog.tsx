...
export const SubtreeOpsDialog = observer_mgl((props: {controller: BoxController} & MI_SharedProps)=>{
	const {mapID, node: rootNode, path: rootNodePath, controller} = props;
