...
export class NodeUI_Menu extends BaseComponentPlus({} as Props, {}) {
	render() {
		...
		AssertUserCanDeleteNode(MeID(), node); // watch
		const userID = MeID();
