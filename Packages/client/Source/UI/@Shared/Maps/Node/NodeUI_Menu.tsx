...
import {ForCopy_GetError, ForCut_GetError, CheckUserCanDeleteNode, GetNodeID, ChildGroup, ClaimForm, NodeL3, NodeType, NodeType_Info, MeID, DMap, GetChildLayout_Final, GetNodeDisplayText, Me, GetValidNewChildConfigsUnderParent, GetDisplayTextForNewChildConfig} from "dm_common";
...
export const NodeUI_Menu_Stub = (props: Props & {delayEventHandler?: boolean})=>{
...
export const NodeUI_Menu = observer_mgl((props: Props)=>{
	...
	const sharedProps: MI_SharedProps = E(props, {mapID, copiedNode, copiedNodePath, copiedNode_asCut});
