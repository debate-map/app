import {GetRating, GetRatingTypeInfo, NodeL3, MeID, NodeRating, NodeRatingType, ShouldRatingTypeBeReversed, TransformRatingForContext, GetFinalAccessPolicyForNewEntry} from "dm_common";
...
import {ES, Slider} from "web-vcore";
import {Button, Column, Row, Select, Text} from "react-vcomponents";
import {RatingsPanel_Old} from "./RatingsPanel_Old.js";
...
export const RatingsPanel = observer_mgl((props: RatingsPanel_Props)=>{
	const {node, ratingType, asNodeUIOverlay} = props;
	if (asNodeUIOverlay) return null;
	if (ratingType == "impact") return <RatingsPanel_Old {...props}/>;
