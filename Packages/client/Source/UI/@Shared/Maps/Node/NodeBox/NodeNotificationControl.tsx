...
import {RunCommand_AddSubscription} from "../../../../../Utils/DB/Command.js";
		...
		return (
			<Div style={{
				...
				<NotificationLevelButton backgroundColor={backgroundColor} active={subscriptionLevel == "none"} onClick={e=>{
					RunCommand_AddSubscription({node: node.id, addChildNode: false, addNodeLink: false, addNodeRevision: false, deleteNode: false, deleteNodeLink: false, setNodeRating: false});
				}}>
				...
				<NotificationLevelButton backgroundColor={backgroundColor} active={subscriptionLevel == "some"} onClick={e=>{
					RunCommand_AddSubscription({node: node.id, addChildNode: true, addNodeLink: false, addNodeRevision: true, deleteNode: false, deleteNodeLink: false, setNodeRating: false});
				}}>
					<svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<NotificationLevelButton backgroundColor={backgroundColor} active={subscriptionLevel == "all"} onClick={e=>{
					RunCommand_AddSubscription({node: node.id, addChildNode: true, addNodeLink: true, addNodeRevision: true, deleteNode: true, deleteNodeLink: true, setNodeRating: true});
				}}>
					<svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
