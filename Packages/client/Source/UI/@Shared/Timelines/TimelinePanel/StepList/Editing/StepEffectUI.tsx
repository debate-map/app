...
import {Button, CheckBox, Column, Pre, Row, Select, Spinner, Text} from "react-vcomponents";
...
type StepEffectUI_Props = {
	map: DMap,
	step: TimelineStep,
	effect: TimelineStepEffect,
	editing: boolean,
	index: number
}

export const StepEffectUI = observer_mgl((props: StepEffectUI_Props)=>{
	const {map, step, effect, editing, index} = props;
...
type EffectUIDetails_General_Props = {
	map: DMap,
	step: TimelineStep,
	stepEffect: TimelineStepEffect,
	stepEffectIndex: number,
	editing: boolean
};

const EffectUIDetails_General = observer_mgl((props: EffectUIDetails_General_Props)=>{
	const {step, stepEffect, stepEffectIndex} = props;
...
type EffectUIDetails_NodeEffect_Props = {
	map: DMap,
	step: TimelineStep,
	stepEffect: TimelineStepEffect,
	stepEffectIndex: number,
...
export const EffectUIDetails_NodeEffect = observer_mgl((props: EffectUIDetails_NodeEffect_Props)=>{
	const {map, step, stepEffect, stepEffectIndex, effect, editing} = props;
...
export const UpdateStepEffect = async(step: TimelineStep, effectIndex: number, baseEffect: TimelineStepEffect, effectModifier: (effect: TimelineStepEffect)=>any)=>{
	// defensive
...
export const UpdateNodeEffect = async(step: TimelineStep, effectIndex: number, baseEffect: TimelineStepEffect, nodeEffectModifier: (nodeEffect: NodeEffect)=>any)=>{
