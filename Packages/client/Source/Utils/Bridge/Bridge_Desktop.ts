...
// empty listeners; added just so that bridge doesn't complain about there being no "main listener" (real listeners are dynamically added in RecordDropdown.tsx)
desktopBridge.RegisterFunction("DebateMap_CaptureFrame_done", ()=>{});
//desktopBridge.RegisterFunction("DebateMap_CaptureFrame_forceBrowserRender", ()=>{});