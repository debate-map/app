...
type CG_RefURLOrQuoteOld = string | CG_QuoteOld;
...
class CG_Debate extends CG_Node {
	name: string;
	questions: CG_Question[];
}
class CG_Question extends CG_Node {
	// v1
...
class CG_Position extends CG_Node {
	position: string;
	categories: CG_Category[];
}
class CG_Category extends CG_Node {
	category: string;
	claims: CG_Claim[];
}
class CG_Claim extends CG_Node {
	// v1
	claim?: string;
...
class CG_Argument extends CG_Node {
...
class CG_Evidence extends CG_Node {
	quote: string;
	url: string;
...
// v7+
class CG_AtomicClaim extends CG_Node {
	text?: string;
}