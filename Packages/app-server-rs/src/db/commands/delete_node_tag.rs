...
#[derive(Default)]
pub struct MutationShard_DeleteNodeTag;
#[Object]
impl MutationShard_DeleteNodeTag {
	async fn delete_node_tag(&self, gql_ctx: &async_graphql::Context<'_>, input: DeleteNodeTagInput) -> Result<DeleteNodeTagResult, Error> {
