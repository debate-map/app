...
#[derive(Default)]
pub struct MutationShard_DeleteShare;
#[Object]
impl MutationShard_DeleteShare {
	async fn delete_share(&self, gql_ctx: &async_graphql::Context<'_>, input: DeleteShareInput) -> Result<DeleteShareResult, Error> {
