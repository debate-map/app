...
#[derive(Default)]
pub struct MutationShard_UpdateNodeTag;
#[Object]
impl MutationShard_UpdateNodeTag {
	async fn update_node_tag(&self, gql_ctx: &async_graphql::Context<'_>, input: UpdateNodeTagInput) -> Result<UpdateNodeTagResult, Error> {
