...
#[derive(Default)]
pub struct MutationShard_DeleteMedia;
#[Object]
impl MutationShard_DeleteMedia {
	async fn delete_media(&self, gql_ctx: &async_graphql::Context<'_>, input: DeleteMediaInput) -> Result<DeleteMediaResult, Error> {
