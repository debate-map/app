...
#[derive(Default)]
pub struct MutationShard_UpdateNodePhrasing;
#[Object]
impl MutationShard_UpdateNodePhrasing {
	async fn update_node_phrasing(&self, gql_ctx: &async_graphql::Context<'_>, input: UpdateNodePhrasingInput) -> Result<UpdateNodePhrasingResult, Error> {
