...
pub struct GQLSet_AccessPolicy { nodes: Vec<AccessPolicy> }
...
impl SubscriptionShard_AccessPolicy {
    async fn accessPolicies(&self, ctx: &Context<'_>, id: Option<String>, filter: Option<serde_json::Value>) -> impl Stream<Item = GQLSet_AccessPolicy> {
